...
class BSTTestCase(unittest.TestCase):
    ...
    def test_search(self):
        ...
        tests for search
        """
        actual_output = self.bst.search(self.bst.root, 40)
        expected_output = "Value for 40"
        self.assertEqual(actual_output, expected_output)

        self.assertFalse(self.bst.search(self.bst.root, 90))

        self.bst.add(90, "Value for 90")
        self.assertEqual(self.bst.search(self.bst.root, 90), "Value for 90")
